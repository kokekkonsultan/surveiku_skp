...
class RekapPertanyaanHarapan_model extends CI_Model
{
    ...
    private function _get_datatables_query($table_identity, $id_pertanyaan_unsur)
    {
        ...
        $this->db->where("jawaban_pertanyaan_harapan_$table_identity.id_pertanyaan_unsur", $id_pertanyaan_unsur);
