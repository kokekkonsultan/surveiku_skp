                ...
                <div class="card-body">
                    ...
                    <!-- <div id="tablex">
                        <div class="custom-control custom-switch mt-5 mb-5">
                            <input type="checkbox" name="setting_value" class="custom-control-input toggle_dash_1" value="1" id="customSwitch1"  {{$profiles->is_emoji_nps == 1 ? 'checked' : ''}}>
    ...
    $(document).ready(function() {
        $('#tablex').on('change', '.toggle_dash_1', function() {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'JSON',
                url: "{{ base_url() }}{{ $ci->session->userdata('username') }}/{{ $ci->uri->segment(2) }}/pertanyaan-nps/is-emoji",
                data: {
                    'mode': mode,
                    'nilai_id': nilai_id
                },
