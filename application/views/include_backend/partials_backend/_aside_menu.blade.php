        ...
        <ul class="menu-nav">
            ...
            <div class="menu-submenu">
                ...
                <ul class="menu-subnav">
                    ...
                    @endphp
                    <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                        <a href="<?php echo base_url() . $ci->session->userdata('username') . '/divisi' ?>"
                            class="menu-link">
                            <i class="menu-bullet menu-bullet-dot">
                                <span></span>
                            </i>
                    ...
                    @endphp
                    <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                        <a href="<?php echo base_url() . $ci->session->userdata('username') . '/pengguna-supervisor' ?>"
                            class="menu-link">
                            <i class="menu-bullet menu-bullet-dot">
                                <span></span>
                            </i>
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}indeks-per-aspek-dimensi" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">Rekap Alasan & Saran</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="menu-submenu">
                    <i class="menu-arrow"></i>
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}e-sertifikat-keseluruhan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Keseluruhan</span>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}e-sertifikat-per-bagian" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Per Bagian</span>
