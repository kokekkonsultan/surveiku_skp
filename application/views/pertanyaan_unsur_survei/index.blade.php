            ...
            <div class="card card-custom bgi-no-repeat gutter-b"
                ...
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <a class="btn btn-secondary font-weight-bold btn-sm" target="_blank" href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/alur-pertanyaan-lompat'}}"><i class="fa fa-random"></i> Alur Pertanyaan Lompat</a>
                        @endif
                    </div>
                </div>
            </div>
