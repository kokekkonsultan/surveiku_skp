        ...
        <div class="col-md-9">
            ...
            <div class="card card-body mb-10">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active font-weight-bold" id="home-tab" data-toggle="tab" href="#tab-chart-aspek">Chart Aspek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" id="benner-tab" data-toggle="tab" href="#tab-chart-dimensi">Chart Dimensi</a>
                    </li>
                ...
                <div class=" tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-chart-aspek" role="tabpanel">
                        <div class="mt-5 mb-5">
                            <div id="chart-aspek"></div>
                        </div>
                    </div>

                    <div class="tab-pane fade" id="tab-chart-dimensi" role="tabpanel">
                        <div class="mt-5 mb-5">
                ...
                <div class="card shadow p-6">
                    ...
                    <div id="dimensi_{{$get->id}}" class="collapse" aria-labelledby="faqHeading1" data-parent="#aspek_{{$value->id}}">
                        <div class="card-body pt-3 font-weight-normal text-dark-50">
                            ...
                            (SELECT SUM(skor_jawaban) FROM jawaban_pertanyaan_unsur_$table_identity JOIN
                            ...
                            pertanyaan_unsur_pelayanan_$table_identity.id) AS sum_skor,
                            
                            (SELECT AVG(IF(jawaban_pertanyaan_unsur_$table_identity.skor_jawaban != 0, skor_jawaban, NULL)) FROM jawaban_pertanyaan_unsur_$table_identity JOIN survey_$table_identity ON jawaban_pertanyaan_unsur_$table_identity.id_responden = survey_$table_identity.id_responden WHERE is_submit = 1 && id_pertanyaan_unsur = pertanyaan_unsur_pelayanan_$table_identity.id) AS avg_skor
                                        ...
                                        <table width="100%" class="table table-bordered" style="font-size: 12px;">
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="{{$unsur->num_rows()}}">
                                                    {{ROUND($nilai_tertimbang[$key], 3)}}</th>
                                            </tr>
        ...
        var myChart = new FusionCharts({
            ...
            dataSource: {
                ...
                data: [
                    ...
                    <?php foreach ($chart_aspek->result() as $row) { ?> {
                            label: "<?= $row->nama_aspek ?>",
