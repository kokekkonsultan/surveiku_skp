...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo e($title . ' - ' . strtoupper($penayang_survei->nama_label)); ?></title>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card shadow" data-aos="fade-up">
                    <?php if($penayang_survei->img_benner == ''): ?>
                    <img class="card-img-top" src="<?php echo e(base_url()); ?>assets/img/site/page/banner-survey.jpg"
                        alt="new image" />
                    <?php else: ?>
                    <img class="card-img-top shadow"
                        src="<?php echo e(base_url()); ?>assets/klien/benner_penayang/<?php echo e($penayang_survei->img_benner); ?>"
                        alt="new image">
                    <?php endif; ?>

                    <div class="card-body">
                        <div class="mb-8">
                            <?php echo $penayang_survei->kata_pembuka; ?>

                        </div>



                        <?php if($penayang_survei->jenis_penayang == 1): ?>
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col-sm-6 col-lg-6 mb-3">
								<?php if($row->is_penayang_blur == 1): ?>
								<div class="text-center font-weight-bold" style="filter: blur(3px);-webkit-filter: blur(3px); cursor: not-allowed;">
                        ...
                        <div class="mt-5 mb-5">
                            <?php $__currentLoopData = $manage_survey->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mt-8">
                            <?php echo $penayang_survei->kata_penutup; ?>
...
<?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/survei_list/index.blade.php ENDPATH**/ ?>