    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-deck">
                    <a href="<?php echo e(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/pertanyaan-terbuka/add/1'); ?>" class="card card-body btn btn-outline-primary shadow">
                        <div class="text-center font-weight-bold">
                            <i class="fas fa-plus"></i><br>Melekat Pada Unsur Pelayanan
                        </div>
                    </a>

                    <a href="<?php echo e(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/pertanyaan-terbuka/add/2'); ?>" class="card card-body btn btn-outline-primary shadow">
                        <div class="text-center font-weight-bold">
...
<!-- <div class="modal fade" id="activate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/pertanyaan-terbuka/activate'); ?>" method="POST" class="form_default_activate">
                    ...
                    <div class="form-group">
                        ...
                        <span class="switch switch-icon">
                            <label>
                                <input type="checkbox" id="is_kategori_pertanyaan_terbuka" name="is_kategori_pertanyaan_terbuka"<?php if($profiles->is_kategori_pertanyaan_terbuka == 1): ?> checked="checked" <?php endif; ?> value="1" />
                                <span></span>
                            </label>
                        </span>
                    </div>
                    <input type="hidden" id="old_is_kategori_pertanyaan_terbuka" name="old_is_kategori_pertanyaan_terbuka" value="<?php echo e($profiles->is_kategori_pertanyaan_terbuka); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/pertanyaan_terbuka_survei/index.blade.php ENDPATH**/ ?>