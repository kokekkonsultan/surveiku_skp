    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Aspek</h5>
            ...
            <div class="modal-body">
                ...
                <form
                    action="<?php echo base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/aspek-survei/add' ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span
                                    class="input-group-text font-weight-bold">A<?php echo e($jumlah_tambahan); ?></span>
                            </div>
                            <input type="text" class="form-control" name="nama_aspek" required autofocus>
                        </div>
                        <input type="hidden" name="kode" value="A<?php echo e($jumlah_tambahan); ?>">
                    </div>
...
<?php echo $__env->make('aspek_survei/edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/aspek-survei/ajax-list' ?>",
            "type": "POST",
            "data": function(data) {}
        },
...
function delete_aspek(id) {
    if (confirm('Are you sure delete this data?')) {
        $.ajax({
            url: "<?php echo base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/aspek-survei/delete/' ?>" +
                id,
            type: "POST",
            dataType: "JSON",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/aspek_survei/index.blade.php ENDPATH**/ ?>