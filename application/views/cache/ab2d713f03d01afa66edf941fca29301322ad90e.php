                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="radio-inline">
                                    ...
                                    <label class="radio"><input type="radio" name="is_sampling" id="0" value="0"
                                            class="sampling" <?php echo e($checked_sampling); ?>><span></span>&nbsp Tanpa
                                        Sampling</label>
                                    <?php
                                    ...
                                    <label class="radio"><input type="radio" name="is_sampling" id="1" value="1"
                                            class="sampling" <?php echo e($checked_sampling); ?>><span></span>&nbsp Dengan
                                        Sampling</label>
                                </div>
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            window.location.href = (
                                '<?php echo e(base_url()); ?><?php echo e($ci->uri->segment(1)); ?>/<?php echo e($ci->uri->segment(2)); ?>/do'
                                );
                        }, 2000);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/manage_survey/form_repository.blade.php ENDPATH**/ ?>