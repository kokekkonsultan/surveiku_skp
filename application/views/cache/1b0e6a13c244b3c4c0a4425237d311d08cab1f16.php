            ...
            <div class="card shadow" data-aos="fade-up">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-next btn-block shadow"
                        href="<?php echo e(base_url() . $ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/preview-form-survei/data-responden'); ?>">
                        IKUT SURVEI
                    </a>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/preview_form_survei/form_opening.blade.php ENDPATH**/ ?>