...
<div id="tablex">
    ...
    <div class="custom-control custom-switch mt-5 mb-5">
        <input type="checkbox" name="setting_value" class="custom-control-input toggle_dash_1" value="<?php echo e($manage_survey->id); ?>" id="customSwitch1" <?php echo e($checked); ?> />
...
</form><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/form_survei/_include/_kata_pembuka.blade.php ENDPATH**/ ?>