...
<body>
    ...
    <div class="" id="navigasi">
        ...
        <div class="" id="group-nav">
            ...
            <?php echo $__env->make('setting_form_survei/_include/_nav_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="" id="form-preview" style="background-image: url(<?php echo e(base_url()); ?>assets/img/bg/main-bg.jpg)">
            ...
            <div class="container mt-5">
                <?php echo $__env->yieldContent('form_preview'); ?>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/setting_form_survei/_include/_template.blade.php ENDPATH**/ ?>