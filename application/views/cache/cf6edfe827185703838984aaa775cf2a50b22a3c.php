            ...
            <div class="card card-custom" data-aos="fade-down">
                <div class="card-header font-weight-bold">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei'); ?>" class="btn btn-sm btn-secondary font-weight-bold mr-2" target="_blank">
                            <i class="flaticon-interface-10"></i> Masuk Ke Pengaturan Form Survei
                        </a>
                        <a href="<?php echo e(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/preview-form-survei/opening'); ?>" class="btn btn-sm btn-primary font-weight-bold" target="_blank">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <?php echo $__env->make('form_survei/_include/_judul', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>

                        <div class="tab-pane fade" id="text" role="tabpanel" aria-labelledby="text-tab">
                            <?php echo $__env->make('form_survei/_include/_font_text', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>


                        <div class="tab-pane fade" id="benner" role="tabpanel" aria-labelledby="benner-tab">
                            <?php echo $__env->make('form_survei/_include/_benner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>


                        <div class="tab-pane fade" id="background" role="tabpanel" aria-labelledby="background-tab">
                            <?php echo $__env->make('form_survei/_include/_latar_belakang', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>


                        <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                            <?php echo $__env->make('form_survei/_include/_kata_pembuka', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>


                        <div class="tab-pane fade" id="tombol" role="tabpanel" aria-labelledby="tombol-tab">
                            <?php echo $__env->make('form_survei/_include/_font_button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>


                        <div class="tab-pane fade" id="saran" role="tabpanel" aria-labelledby="saran-tab">
                            <?php echo $__env->make('form_survei/_include/_form_saran', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>


                        <div class="tab-pane fade" id="penutup" role="tabpanel" aria-labelledby="penutup-tab">
                            <?php echo $__env->make('form_survei/_include/_kata_penutup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<script>
    $(function() {
        ...
        $('#cp3').colorpicker({
            "color": "<?php echo e($warna_latar_belakang1); ?>"
        });
        $('#cp1').colorpicker({
            "color": "<?php echo e($warna_latar_belakang2); ?>"
        });
        $('#cp2').colorpicker({
            "color": "<?php echo e($warna_latar_belakang3); ?>"
        });

        $('#cp6').colorpicker({
            "color": "<?php echo e($warna_benner1); ?>"
        });
        $('#cp4').colorpicker({
            "color": "<?php echo e($warna_benner2); ?>"
        });
        $('#cp5').colorpicker({
            "color": "<?php echo e($warna_benner3); ?>"
        });
    });
</script>
    ...
    $(document).ready(function() {
        ...
        $('#tanggal_survei').on('change', '.toggle_tanggal_1', function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: "<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/form-survei/update-is-display-tanggal-survei",
                data: {
                    'mode': mode,
                    'nilai_id': nilai_id
                },
                success: function(data) {
                    ...
                    setTimeout(function() {
                        window.location.href = (
                            "<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/form-survei"
                        );
                    }, 2000);
        ...
        $('#tableBanner').on('change', '.toggle_banner_1', function() {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'JSON',
                url: "<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/form-survei/update-is-banner",
                data: {
                    'mode': mode,
                    'nilai_id': nilai_id,
        ...
        function ganti_warna_backgorund(mode, nilai_id, warna_latar_belakang) {
            $.ajax({
                ...
                type: 'POST',
                dataType: 'JSON',
                url: "<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/form-survei/update-is-background",
                data: {
                    'mode': mode,
                    'nilai_id': nilai_id,
        ...
        document.getElementById("warna1").onchange = function() {
            var mode = $(this).prop('checked');
            var nilai_id = '<?php echo e($manage_survey->is_benner); ?>';
            warna_benner = $('input:enabled[name="warna_benner[]"]').map(function() {
                return $(this).val();
            }).get();
        ...
        document.getElementById("warna4").onchange = function() {
            var mode = $(this).prop('checked');
            var nilai_id = '<?php echo e($manage_survey->is_latar_belakang); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/form_survei/index.blade.php ENDPATH**/ ?>