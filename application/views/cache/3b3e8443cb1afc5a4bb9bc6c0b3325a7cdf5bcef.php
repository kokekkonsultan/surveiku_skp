...
<html lang="en">
  <head>
    ...
    <title><?php echo (isset($title)) ? $title : "SurveiKu"; ?></title>
	<link rel="shortcut icon" type="image/png" href="<?php echo e(base_url()); ?>assets/img/site/content/favicon.png"/>
    <link href="<?php echo e(base_url()); ?>assets/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">
    <link href="<?php echo e(base_url()); ?>assets/vendor/aos/aos.css" rel="stylesheet">
	<link href="<?php echo e(base_url()); ?>assets/vendor/sweetalert/sweetalert2.min.css" rel="stylesheet">
	<link href="<?php echo e(base_url()); ?>assets/vendor/sweetalert/all.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css">
	<link href="<?php echo e(base_url()); ?>assets/vendor/sweetalert/animate.min.css" rel="stylesheet">
  ...
  <body>
	...
	<script src="<?php echo e(base_url()); ?>assets/vendor/sweetalert/sweetalert2.min.js"></script>
	<script src="<?php echo e(base_url()); ?>assets/vendor/aos/aos.js"></script>
	<script>
		function user_logout() {
			$.ajax({
                    url: "<?php echo e(base_url()); ?>auth/logout",
                    type: "POST",
                    dataType: "JSON",
                    beforeSend: function() {
                        Swal.fire({
...
<?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/include_backend/template_auth.blade.php ENDPATH**/ ?>