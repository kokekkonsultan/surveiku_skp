...
<div class="mt-10 mb-10" id="display_<?php echo e($row_terbuka_atas->nomor_pertanyaan_terbuka); ?>">
    ...
    <table class="table table-borderless" width="100%" border="0">
        <tr>
            <td width="5%" valign="top"><?php echo $row_terbuka_atas->nomor_pertanyaan_terbuka . '' . $is_required_ta; ?>.
            </td>
            ...
            <td style="font-weight:bold;" width="95%">
                ...
                <div class="<?php echo e($model_ta); ?>-inline mb-2">
                    <label class="<?php echo e($model_ta); ?> <?php echo e($model_ta); ?>-outline <?php echo e($model_ta); ?>-success <?php echo e($model_ta); ?>-lg" style="font-size: 16px;">
                        <input type="<?php echo e($model_ta); ?>" name="jawaban_pertanyaan_terbuka[<?php echo e($row_terbuka_atas->id_pertanyaan_terbuka); ?>][]" value="<?php echo e($value_terbuka->pertanyaan_ganda); ?>" class="terbuka_<?php echo e($row_terbuka_atas->nomor_pertanyaan_terbuka); ?>" <?= $value_terbuka->pertanyaan_ganda == $row_terbuka_atas->jawaban ? 'checked' : '' ?> <?php echo e($is_required_ta_i); ?> <?= in_array($value_terbuka->pertanyaan_ganda, unserialize($row_terbuka_atas->jawaban)) ? 'checked' : ''; ?>>
                        <span></span>
                        <?php echo e($value_terbuka->pertanyaan_ganda); ?>
                ...
                <input class="form-control" name="jawaban_lainnya[<?php echo e($row_terbuka_atas->id_pertanyaan_terbuka); ?>]" value="<?php echo e($row_terbuka_atas->jawaban_lainnya); ?>" pattern="^[a-zA-Z0-9.,\s]*$|^\w$" placeholder="Masukkan jawaban lainnya ..." id="terbuka_lainnya_<?php echo e($row_terbuka_atas->nomor_pertanyaan_terbuka); ?>" <?= in_array('Lainnya', unserialize($row_terbuka_atas->jawaban)) ? 'required' : 'style="display:none"'; ?>>

                <small id="text_terbuka_<?php echo e($row_terbuka_atas->nomor_pertanyaan_terbuka); ?>" class="text-danger" <?= in_array('Lainnya', unserialize($row_terbuka_atas->jawaban)) ? '' : 'style="display:none"'; ?>>**Pengisian
        ...
        <tr>
            ...
            <td style="font-weight:bold;" width="95%">
                ...
                <textarea class="form-control terbuka_<?php echo e($row_terbuka_atas->nomor_pertanyaan_terbuka); ?>" type="text" name="jawaban_pertanyaan_terbuka[<?php echo e($row_terbuka_atas->id_pertanyaan_terbuka); ?>][]" placeholder="Masukkan Jawaban Anda ..." <?= $row_terbuka_atas->stts_required ?>><?php echo e($row_terbuka_atas->jawaban != '' ?  implode("", unserialize($row_terbuka_atas->jawaban)) : ''); ?></textarea>
            </td>
        </tr>
...
?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\skp_surveiku\application\views/survei/pertanyaan_terbuka/_tanpa_kategori/form_terbuka_atas.blade.php ENDPATH**/ ?>