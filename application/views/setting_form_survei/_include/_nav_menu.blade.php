...
<div class="" id="primary-menu" onMouseOver="show('in-primary-label')" onMouseOut="hide('in-primary-label')">
    <div class="" id="sub-primary-menu">
        ...
        <div class="in-primary-group">
            <div class="in-primary-menu">
                <img src="{{ base_url() }}assets/img/site/logo/logo-dark2.png" alt="" width="30px">
            </div>
        </div>
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei/form-benner'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei/form-pembuka'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei/form-font-text'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei/form-tombol'}}"
    ...
    <!-- <div class="in-primary-group">
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei/form-saran'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/setting-form-survei/form-penutup'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/alur-pertanyaan-lompat'}}"
        ...
        <div class="in-primary-group">
            ...
            <div class="in-primary-label">
                <a href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/do'}}">
                    Kembali
                </a>
            </div>
        </div>
