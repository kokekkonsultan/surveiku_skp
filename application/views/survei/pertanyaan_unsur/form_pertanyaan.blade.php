...
<div class="container mt-5 mb-5" style="font-family: 'Exo 2', sans-serif;">
    ...
    <form action="{{base_url() . 'survei/' . $ci->uri->segment(2) . '/add_pertanyaan/' . $ci->uri->segment(4)}}"
                                ...
                                <tr>
                                    ...
                                    <td width="95%">
                                        ...
                                        <textarea class="form-control form-alasan" type="text"
                                            name="alasan_pertanyaan_unsur[{{ $i }}]" id="input_alasan_{{$row->nomor}}"
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <a class="btn btn-back btn-lg shadow"
                                        href="{{ base_url() . 'survei/' . $ci->uri->segment(2) . '/data-responden/' . $ci->uri->segment(4) . '/' . $segment5 }}">Kembali</a>
                                </td>
