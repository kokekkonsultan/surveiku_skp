                            ...
                            <table class="table table-borderless" width="100%" border="0">
                                    ...
                                    <td style="font-weight:bold;" width="95%">
                                        ...
                                        <div class="radio-inline mb-2">
                                            <label class="radio radio-outline radio-success radio-lg" style="font-size: 16px;">
                                                ...
                                                <input type="radio" name="jawaban_pertanyaan_unsur[{{ $i }}]" value="{{$value->nomor_kategori_unsur_pelayanan}}" class="unsur_{{$value->id_pertanyaan_unsur}}" <?= $value->nomor_kategori_unsur_pelayanan == $row->skor_jawaban ? 'checked' : '' ?> {{ $is_required }}><span></span>
                                ...
                                <tr>
                                    ...
                                    <td width="95%">
                                        ...
                                        <textarea class="form-control form-alasan" type="text" name="alasan_pertanyaan_unsur[{{ $i }}]" id="input_alasan_{{$row->id_pertanyaan_unsur}}" placeholder="Berikan alasan jawaban anda ..." pattern="^[a-zA-Z0-9.,\s]*$|^\w$" <?= $row->skor_jawaban == 1 || $row->skor_jawaban == 2 ? 'required' : 'style="display:none"' ?>>{{ $row->alasan_jawaban }}</textarea>
