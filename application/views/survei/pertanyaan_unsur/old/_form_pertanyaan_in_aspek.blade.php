            ...
            <div class="card shadow mb-4 mt-4" data-aos="fade-up" style="font-family: 'Exo 2', sans-serif;">
                ...
                <form
                    ...
                    <div class="card-body ml-5 mr-5">
                        ...
                        @foreach(
                        $ci->db->query("SELECT *
                        FROM (SELECT *, (SELECT COUNT(id) FROM dimensi_$manage_survey->table_identity WHERE
                        dimensi_$manage_survey->table_identity.id_aspek = aspek_$manage_survey->table_identity.id) AS
                        jumlah
                        FROM aspek_$manage_survey->table_identity) ask_$manage_survey->table_identity
                        WHERE jumlah > 0
                        ORDER BY id ASC")->result() as $ask
                        )
                        ...
                        WHERE jumlah > 0 && id_aspek = $ask->id
                        ...
                        <div class="text-center" style="background-color: #FCF7B6; padding: 5px; font-family: 'Exo 2', sans-serif; color:#294087;">
                            ...
                            <h4 class="mt-2" style="color:#f75252;"><b>{{strtoupper($ask->nama_aspek)}}</b></h4>
                                        ...
                                        <div class="radio-inline mb-2">
                                            <label class="radio radio-outline radio-success radio-lg"
                                                ...
                                                <input type="radio" name="jawaban_pertanyaan_unsur[{{ $i }}]"
                                                    ...
                                                    class="unsur_{{$value->id_pertanyaan_unsur}}"
                                ...
                                <tr>
                                    ...
                                    <td width="95%">
                                        ...
                                        <textarea class="form-control form-alasan" type="text"
                                            ...
                                            id="input_alasan_{{$row->id_pertanyaan_unsur}}"
